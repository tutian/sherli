    ...
    var walletDetailCreateDom = function(data) {
        ...
        if (data && data.length !== 0) {
            ...
            for (i = 0; i < data.length; i += 1) {
                ...
                walletDetailHtml += "<div class='coin-item'><div class='coin-item-main'><div class='coin-item-right fr'><p class='coin-item-right-top'>" + disc + "</p><p class='coin-item-right-bottom'>芝麻币</p></div><div class='coin-item-left'>" + item.note + "</div></div><p class='coin-item-footer'><time datetime='" + item.time + "'>" + item.time + "</time></p></div>";
            }
